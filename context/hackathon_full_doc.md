...
3. Delegation via Synced Vault (Phase 1)
   - a. Agents communicate by writing files into: /Needs_Action/<domain>/, /Plans/<domain>/, /Pending_Approval/<domain>/
...
Runs in your terminal, pointed at your Obsidian vault. It uses its File System tools to read your tasks and write reports. The Ralph Wiggum loop (a Stop hook) keeps Claude iterating until multi-step tasks are complete.
...
| Claude Code Fundamentals | https://agentfactory.panaversity.org/docs/AI-Tool-Landscape/claude-code-features-and-workflows | 3 hours |
